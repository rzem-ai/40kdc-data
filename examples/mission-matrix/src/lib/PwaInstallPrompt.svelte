<script lang="ts">
  ...
  /**
   * Nudges users to install Mission Matrix as a PWA after the app version bumps.
  ...
  const STORAGE_KEY = "mission-matrix.pwa-install-prompt.version";
...
<Modal bind:open title="Install Mission Matrix">
  {#if iosMode}
    <p class="lead">Add Mission Matrix to your home screen to play offline, full-screen.</p>
    <ol class="steps">
  ...
  {:else}
    <p class="lead">
      Install Mission Matrix as an app — it works offline, launches full-screen, and keeps your
      in-progress game.
    </p>
    <div class="actions">
